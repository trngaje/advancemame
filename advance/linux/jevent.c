...
static adv_error joystickb_setup(struct joystick_item_context* item, int f)
{
	...
	struct override_entry {
		...
		{ 0x484b, 0x1100, "GO-Super Gamepad", 10, "happy3", JOYB_HAPPY3 },
		{ 0x484b, 0x1100, "GO-Super Gamepad", 11, "happy4", JOYB_HAPPY4 },
		{ 0x484b, 0x1100, "GO-Super Gamepad", 12, "happy5", JOYB_HAPPY5 },
		{ 0x484b, 0x1100, "GO-Super Gamepad", 13, "happy6", JOYB_HAPPY6 },

		{ 0x484b, 0x1000, "GO-Advance Gamepad", 1, "a", JOYB_A },
		{ 0x484b, 0x1000, "GO-Advance Gamepad", 0, "b", JOYB_B },
		{ 0x484b, 0x1000, "GO-Advance Gamepad", 2, "x", JOYB_X },
		{ 0x484b, 0x1000, "GO-Advance Gamepad", 3, "y", JOYB_Y },
		{ 0x484b, 0x1000, "GO-Advance Gamepad", 4, "tl", JOYB_TL },
		{ 0x484b, 0x1000, "GO-Advance Gamepad", 5, "tr", JOYB_TR },
		{ 0x484b, 0x1000, "GO-Advance Gamepad", 6, "tl2", JOYB_TL2 },
		{ 0x484b, 0x1000, "GO-Advance Gamepad", 7, "tr2", JOYB_TR2 },	
		{ 0x484b, 0x1000, "GO-Advance Gamepad", 8, "happy1", JOYB_HAPPY1 },
		{ 0x484b, 0x1000, "GO-Advance Gamepad", 9, "happy2", JOYB_HAPPY2 },		
		{ 0x484b, 0x1000, "GO-Advance Gamepad", 10, "happy3", JOYB_HAPPY3 },
		{ 0x484b, 0x1000, "GO-Advance Gamepad", 11, "happy4", JOYB_HAPPY4 },
		{ 0x484b, 0x1000, "GO-Advance Gamepad", 12, "happy5", JOYB_HAPPY5 },
		{ 0x484b, 0x1000, "GO-Advance Gamepad", 13, "happy6", JOYB_HAPPY6 },

		{ 0x484b, 0x1000, "GO-Advance Gamepad (rev 1.1)", 1, "a", JOYB_A },
		{ 0x484b, 0x1000, "GO-Advance Gamepad (rev 1.1)", 0, "b", JOYB_B },
		{ 0x484b, 0x1000, "GO-Advance Gamepad (rev 1.1)", 2, "x", JOYB_X },
		{ 0x484b, 0x1000, "GO-Advance Gamepad (rev 1.1)", 3, "y", JOYB_Y },
		{ 0x484b, 0x1000, "GO-Advance Gamepad (rev 1.1)", 4, "tl", JOYB_TL },
		{ 0x484b, 0x1000, "GO-Advance Gamepad (rev 1.1)", 5, "tr", JOYB_TR },
		{ 0x484b, 0x1000, "GO-Advance Gamepad (rev 1.1)", 6, "tl2", JOYB_TL2 },
		{ 0x484b, 0x1000, "GO-Advance Gamepad (rev 1.1)", 7, "tr2", JOYB_TR2 },	
		{ 0x484b, 0x1000, "GO-Advance Gamepad (rev 1.1)", 8, "happy1", JOYB_HAPPY1 },
		{ 0x484b, 0x1000, "GO-Advance Gamepad (rev 1.1)", 9, "happy2", JOYB_HAPPY2 },		
		{ 0x484b, 0x1000, "GO-Advance Gamepad (rev 1.1)", 10, "happy3", JOYB_HAPPY3 },
		{ 0x484b, 0x1000, "GO-Advance Gamepad (rev 1.1)", 11, "happy4", JOYB_HAPPY4 },
		{ 0x484b, 0x1000, "GO-Advance Gamepad (rev 1.1)", 12, "happy5", JOYB_HAPPY5 },
		{ 0x484b, 0x1000, "GO-Advance Gamepad (rev 1.1)", 13, "happy6", JOYB_HAPPY6 },
		
		{ 0x484b, 0x1000, "GO-Advance-RK Gamepad", 1, "a", JOYB_A },
		{ 0x484b, 0x1000, "GO-Advance-RK Gamepad", 0, "b", JOYB_B },
		{ 0x484b, 0x1000, "GO-Advance-RK Gamepad", 2, "x", JOYB_X },
		{ 0x484b, 0x1000, "GO-Advance-RK Gamepad", 3, "y", JOYB_Y },
		{ 0x484b, 0x1000, "GO-Advance-RK Gamepad", 4, "tl", JOYB_TL },
		{ 0x484b, 0x1000, "GO-Advance-RK Gamepad", 5, "tr", JOYB_TR },
		{ 0x484b, 0x1000, "GO-Advance-RK Gamepad", 6, "tl2", JOYB_TL2 },
		{ 0x484b, 0x1000, "GO-Advance-RK Gamepad", 7, "tr2", JOYB_TR2 },	
		{ 0x484b, 0x1000, "GO-Advance-RK Gamepad", 8, "happy3", JOYB_HAPPY3 },
		{ 0x484b, 0x1000, "GO-Advance-RK Gamepad", 9, "happy4", JOYB_HAPPY4 },		
