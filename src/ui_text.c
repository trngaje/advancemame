...
static const char *mame_default_text[] =
{
	...
	"Resize Effect [max]",
	"Resize Effect [mean]",
	"Resize Effect [filter]",
	"Resize Effect [scalex]",
	"Resize Effect [scalek]",
	"Resize Effect [hq]",
	"Resize Effect [xbr]",
	"Rgb Effect [no]",
	"Rgb Effect [triad3dot]",
	"Rgb Effect [triad6dot]",
	"Rgb Effect [triad16dot]",
	"Rgb Effect [triadstrong3dot]",
	"Rgb Effect [triadstrong6dot]",
	"Rgb Effect [triadstrong16dot]",
	"Rgb Effect [scan2horz]",
	"Rgb Effect [scan3horz]",
	"Rgb Effect [scan2vert]",
	"Rgb Effect [scan3vert]",	
	"Details...",
	"Save for this game",
	"Save for this game size/freq",
	"Save for all vector games",
	"Save for this game size",
	"Audio Pipeline",
	"Audio Menu",
	"Mode [mono]",
	"Mode [stereo]",
